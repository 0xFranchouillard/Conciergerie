...
{
    public $conn;
    public $table_name = "intervention";
    ...
    function create()
    {
        ...
        $query = "INSERT INTO " . $this->table_name . " VALUES('$this->interventionID','$this->pastHour','$this->pastType','$this->view','$this->notation','$this->userID','$this->serviceID','$this->agency')";
        // prepare w
        $stmt = $this->conn->prepare($query);
        // execute query
        if ($stmt->execute()) {
            return json_encode(["interventionID"=>"$this->interventionID"],JSON_PRETTY_PRINT);
